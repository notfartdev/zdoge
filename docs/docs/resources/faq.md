...
zDoge is currently on testnet and undergoing development. Audits will be conducted before mainnet launch. See our [Trust Model](/resources/trust-model) for details on what is cryptographically enforced vs what requires trust.

### What do I need to trust when using zDoge?

See our detailed [Trust Model documentation](/resources/trust-model). In summary:
