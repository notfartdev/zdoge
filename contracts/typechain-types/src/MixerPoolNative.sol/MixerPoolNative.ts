...
export interface MixerPoolNativeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "FIELD_SIZE"
      | "ROOT_HISTORY_SIZE"
...
export interface MixerPoolNative extends BaseContract {
  connect(runner?: ContractRunner | null): MixerPoolNative;
  waitForDeployment(): Promise<this>;

  interface: MixerPoolNativeInterface;
